...
class ProductosProvider {
  ...
  final String _url = 'https://flutter-varios-7ce9a.firebaseio.com';
  ...
  Future<String> subirImagen(File imagen) async {
    ...
    final url = Uri.parse('https://api.cloudinary.com/v1_1/dd5fc8eod/image/upload?upload_preset=ma91g3ho');
